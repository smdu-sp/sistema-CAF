...
export default async function SetoresAssinaturaPage({ searchParams }: PageProps) {
  ...
  return (
    <Suspense fallback={null}>
      <SetoresContent pagina={pagina} limite={limite} />
    </Suspense>
  );
}

async function SetoresContent({ pagina, limite }: { pagina: number; limite: number }) {
