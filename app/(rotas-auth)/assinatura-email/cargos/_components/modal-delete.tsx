...
export default function ModalDelete({
  ...
  async function handleAction() {
    const res = await fetch(`/api/assinatura-email/cargos/${id}`, {
      method: "PATCH",
    ...
    toast.success(status ? "Cargo ativado com sucesso" : "Cargo desativado com sucesso");
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{status ? "Ativar Cargo" : "Desativar Cargo"}</DialogTitle>
        </DialogHeader>
        <p>
          {status
