	...
	if (collapsible === 'none') {
		return (
			<div
				data-slot='sidebar'
				className={cn(
					'bg-background text-sidebar-foreground flex h-full w-[var(--sidebar-width)] flex-col',
					className,
				)}
				{...props}>
				{children}
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				'text-sidebar-foreground/50 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-[11px] font-semibold uppercase tracking-[0.08em] outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
